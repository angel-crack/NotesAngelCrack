...
```powershell fold title:"ng new [name]"
ng new [name]
...
Options:
  ...
  -S, --skip-tests          Do not generate "spec.ts" test files for the new project.         [boolean] [default: false]
      ...
      --strict              Creates a workspace with stricter type checking and stricter bundle budgets settings. This
                            ...
                            see https://angular.io/guide/strict-mode                           [boolean] [default: true]
...
[+] Podriamos correr entonces para generar un [[Angular]] project

``` powershell fold title:"ng new project-a --routing --style=css"
...
[+] Y despues corremos el proyecto para ver si funciona
